package data_base.Entity;


// Entity : 데이터 베이스의 테이블과 서로 매핑되는 Java Class 
// 목적 : 데이터 베이스 테이블의 각각의 레코드를 인스턴스로 받기 위한 용도 
// 조건 : 데이터 베이스의 테이블의 각 컬럼명, 데이터 타입과 Entity class의 필드명, 데이터 타입이 일치해야함 


//boardNUmber INT AUTO_INCREMENT PRIMARY KEY,
//boardTitle  VARCHAR(200) NOT NULL,
//boardContent TEXT NOT NULL, #문자열 길이가 상관없는것은 TEXT로 표현 
